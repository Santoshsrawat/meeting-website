...
! function(s) {
    ...
    s.fn.mobileMenu = function(e) {
        ...
        return this.each(function() {
            function n() {
                1 == d.FromRight ? c.css("left", -d.MenuWidth) : c.css("right", -d.MenuWidth), c.find("ul:first").addClass(d.ClassName), g = d.ClassName, c.css("width", d.MenuWidth), c.find("." + g + " ul").css("display", "none");
